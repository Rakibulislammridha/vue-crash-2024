...
<template>
    <section class="bg-green-50" style="margin-top: 20px;">
        <div class="m-auto max-w-2xl py-24" style="max-width: 1300px;">
            <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                <form @submit.prevent="handleSubmit">
                    <h2 class="text-3xl text-center font-semibold mb-6 mt-10">Edit Job</h2>
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700 font-bold mb-2">Job Listing Title</label>
